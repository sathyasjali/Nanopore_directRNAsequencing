process READLENGTH_HISTOGRAM {
    ...
    output:
        tuple val(sample_id), 
              path("${sample_id}_read_lengths.txt"), 
              path("${sample_id}_read_length_histogram.png")
    ...
    # Extract read lengths (fixed escaping issue)
    ...
    # Run the Python script for plotting with sample ID
